...
final class SVGRectangle: SVGShapeElement {
	...
	func rectangleHeight(height: String) {
		guard let height = CGFloat(height) else { return }
	...
	func rectangleWidth(width: String) {
		guard let width = CGFloat(width) else { return }
	...
	func xCornerRadius(xCornerRadius: String) {
		guard let xCornerRadius = CGFloat(xCornerRadius) else { return }
	...
	func yCornerRadius(yCornerRadius: String) {
		guard let yCornerRadius = CGFloat(yCornerRadius) else { return }
